...
Takes penguins df, drops all the na rows, then renames body_mass_g, bill_length_mm, bill_depth_mm, and flipper_length_mm to mass, bill_l, bill_d, and flip_l, respectively. 
